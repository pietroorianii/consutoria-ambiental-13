    ...
    <PageWrapper>
      ...
      <section className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-b from-eco-green/90 to-eco-blue/90">
        ...
        <div className="absolute inset-0 bg-cover bg-center opacity-20" 
             style={{backgroundImage: "url('https://images.unsplash.com/photo-1464938050520-ef2270bb8ce8?auto=format&fit=crop&q=80&w=1200&h=600')"}}>
        </div>
      ...
      <section className="container py-24 relative">
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16 scroll-trigger">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6" style={{fontFamily: "'Poppins', sans-serif"}}>
              Nossa História
            </h2>
          ...
          <div className="glass-card p-8 md:p-10 shadow-soft backdrop-blur-lg scroll-trigger">
            <p className="mb-6 text-lg leading-relaxed">
              Fundada em 2010, a L&P Soluções Ambientais nasceu com o propósito de transformar a relação entre empresas e meio ambiente, 
