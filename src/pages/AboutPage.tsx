...
const AboutPage = () => {
  return (
    <PageWrapper>
      ...
      <PageHeader 
        title="Sobre Nós" 
        description="Conheça nossa história, valores e a equipe de especialistas por trás da EcoConsult." 
        icon={<TreeDeciduous className="h-12 w-12 text-white" />} 
        backgroundImage="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&q=80&w=1200&h=600" 
      />
      ...
      <section className="container py-16 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            <div className="text-center lg:text-left scroll-trigger">
            ...
            <p className="text-muted-foreground scroll-trigger" style={{
          ...
          <div className="relative rounded-lg overflow-hidden shadow-lg scroll-trigger">
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background/80 backdrop-blur-sm rounded-lg p-8 shadow-md hover:shadow-lg transition-all animate-fade-up" style={{
              ...
              <h3 style={{
                fontFamily: "'Poppins', sans-serif"
              }} className="font-semibold mb-4 text-eco-green text-center text-2xl">Missão</h3>
              <p style={{
                fontFamily: "'Lato', sans-serif"
            ...
            <div className="bg-background/80 backdrop-blur-sm rounded-lg p-8 shadow-md hover:shadow-lg transition-all animate-fade-up" style={{
              ...
              <h3 style={{
                fontFamily: "'Poppins', sans-serif"
              }} className="font-semibold mb-4 text-eco-blue text-center text-2xl">Visão</h3>
              <p style={{
                fontFamily: "'Lato', sans-serif"
              }} className="text-muted-foreground text-center text-lg">
            ...
            <div className="bg-background/80 backdrop-blur-sm rounded-lg p-8 shadow-md hover:shadow-lg transition-all animate-fade-up" style={{
              ...
              <h3 style={{
                fontFamily: "'Poppins', sans-serif"
              }} className="font-semibold mb-4 text-eco-earth-dark text-center text-2xl">Valores</h3>
              <ul style={{
                fontFamily: "'Lato', sans-serif"
              }} className="text-muted-foreground space-y-2 flex flex-col items-center rounded-lg">
      ...
      <section className="container py-16 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            <div 
              key={index} 
              className="bg-background/80 backdrop-blur-sm border border-border/50 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow scroll-trigger"
            >
