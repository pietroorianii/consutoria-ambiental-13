    ...
    <PageWrapper>
      ...
      <div className="bg-gradient-to-r from-eco-green/90 to-eco-blue/90 py-12 md:py-16 relative overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&q=80&w=1200&h=600')"
        }}>
        </div>
      ...
      <section className="container py-16 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6 animate-fade-up" style={{
            ...
            <div>
              <h2 className="text-3xl font-bold text-center lg:text-left" style={{
                fontFamily: "'Poppins', sans-serif"
              }}>Nossa História</h2>
        ...
        <div className="container relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background/80 backdrop-blur-sm rounded-lg p-8 shadow-md hover:shadow-lg transition-all animate-fade-up" style={{
              ...
              <h3 className="text-xl font-semibold mb-4 text-eco-green" style={{
                fontFamily: "'Poppins', sans-serif"
              }}>Missão</h3>
              <p className="text-muted-foreground" style={{
                fontFamily: "'Lato', sans-serif"
            ...
            <div className="bg-background/80 backdrop-blur-sm rounded-lg p-8 shadow-md hover:shadow-lg transition-all animate-fade-up" style={{
              ...
              <h3 className="text-xl font-semibold mb-4 text-eco-blue" style={{
                fontFamily: "'Poppins', sans-serif"
              }}>Visão</h3>
              <p className="text-muted-foreground" style={{
                fontFamily: "'Lato', sans-serif"
            ...
            <div className="bg-background/80 backdrop-blur-sm rounded-lg p-8 shadow-md hover:shadow-lg transition-all animate-fade-up" style={{
              ...
              <h3 className="text-xl font-semibold mb-4 text-eco-earth-dark" style={{
                fontFamily: "'Poppins', sans-serif"
              }}>Valores</h3>
              <ul className="text-muted-foreground space-y-2" style={{
                fontFamily: "'Lato', sans-serif"
              }}>
