        ...
        <div className="bg-gradient-to-r from-eco-green/90 to-eco-blue/90 py-12 md:py-16 relative overflow-hidden">
          ...
          <div className="container relative z-10">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white" style={{ fontFamily: "'Poppins', sans-serif" }}>Nossos Serviços</h1>
        ...
        <section className="container py-16">
          <div className="space-y-16">
            {serviceCategories.map((category, index) => (
              <div key={index} className={`grid grid-cols-1 lg:grid-cols-2 gap-10 items-center ${index % 2 !== 0 ? 'lg:flex-row-reverse' : ''} animate-fade-up`} style={{ animationDelay: `${0.1 + index * 0.1}s` }}>
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    <div className="bg-eco-green/10 p-4 rounded-full">
                      {category.icon}
                    </div>
                    <h2 className="text-3xl font-bold" style={{ fontFamily: "'Poppins', sans-serif" }}>{category.title}</h2>
                  </div>
                  
                  <p className="text-muted-foreground text-lg" style={{ fontFamily: "'Lato', sans-serif" }}>
        ...
        <section className="bg-gradient-to-br from-muted to-muted/50 py-16 leaf-pattern">
          <div className="container">
            <div className="text-center mb-12 animate-fade-up">
              <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>Como Trabalhamos</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="relative bg-background rounded-lg p-8 shadow-sm animate-fade-up" style={{ animationDelay: "0.2s" }}>
                ...
                <h3 className="text-xl font-semibold mb-4 mt-2" style={{ fontFamily: "'Poppins', sans-serif" }}>Diagnóstico</h3>
              ...
              <div className="relative bg-background rounded-lg p-8 shadow-sm animate-fade-up" style={{ animationDelay: "0.3s" }}>
                <div className="absolute -top-4 -left-4 w-12 h-12 rounded-full bg-eco-green flex items-center justify-center text-white font-bold text-lg">
                  2
                </div>
                <h3 className="text-xl font-semibold mb-4 mt-2" style={{ fontFamily: "'Poppins', sans-serif" }}>Planejamento</h3>
                <p className="text-muted-foreground" style={{ fontFamily: "'Lato', sans-serif" }}>
                  Desenvolvemos um plano de ação personalizado, com cronograma e definição clara dos entregáveis e responsabilidades.
                </p>
              </div>
              
              <div className="relative bg-background rounded-lg p-8 shadow-sm animate-fade-up" style={{ animationDelay: "0.4s" }}>
                <div className="absolute -top-4 -left-4 w-12 h-12 rounded-full bg-eco-green flex items-center justify-center text-white font-bold text-lg">
                  3
                </div>
                <h3 className="text-xl font-semibold mb-4 mt-2" style={{ fontFamily: "'Poppins', sans-serif" }}>Execução</h3>
                <p className="text-muted-foreground" style={{ fontFamily: "'Lato', sans-serif" }}>
