...
export function FeaturedServices() {
  return (
    <section className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="absolute top-10 right-10 w-32 h-32 bg-eco-green/5 rounded-full blur-2xl animate-pulse-slow"></div>
      <div className="absolute bottom-10 left-10 w-40 h-40 bg-eco-blue/5 rounded-full blur-2xl animate-pulse-slow" style={{animationDelay: '2s'}}></div>
      
      <div className="container relative z-10">
        <div className="text-center mb-20 scroll-trigger">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-eco-green/10 text-eco-green font-medium text-sm uppercase tracking-wider rounded-full mb-8 hover:bg-eco-green/15 transition-colors">
