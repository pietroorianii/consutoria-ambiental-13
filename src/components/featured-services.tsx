...
export function FeaturedServices() {
  return <section className="container py-16 md:py-24 relative">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => <Card key={index} className="border border-border/70 eco-card h-full flex flex-col bg-white/90 backdrop-blur-sm hover:shadow-lg hover:shadow-eco-green/5 hover:border-eco-green/20 transition-all duration-300 animate-fade-up" style={{
          animationDelay: `${0.2 + index * 0.1}s`
              ...
              <CardFooter className="mt-auto pt-4 flex justify-center bg-neutral-200 rounded-none">
