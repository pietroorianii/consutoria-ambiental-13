    ...
    <div className="relative overflow-hidden min-h-[90vh] flex items-center">
      ...
      <div className="container relative z-10 py-24 md:py-36 flex flex-col items-center text-center">
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white max-w-5xl animate-fade-in mb-6" style={{
          ...
          Garanta a Conformidade Ambiental do seu Negócio
        </h1>
        ...
        <p style={{
          ...
          Navegue pela legislação ambiental sem complicações. Oferecemos a expertise que sua empresa precisa para operar com segurança, evitar multas e crescer de forma sustentável.
        </p>
