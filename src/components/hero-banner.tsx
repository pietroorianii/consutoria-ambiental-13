...
export function HeroBanner() {
  return <div className="relative overflow-hidden min-h-[90vh] flex items-center">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 right-20 leaf-decoration animate-spin-slow opacity-40 hidden lg:block"></div>
      <div className="absolute bottom-40 left-16 leaf-decoration animate-spin-slow opacity-30 hidden lg:block"></div>
      ...
      <div className="container relative z-10 py-24 md:py-36 flex flex-col items-center text-center">
        ...
        <div style={{
        animationDelay: "0.6s"
      }} className="flex flex-col sm:flex-row gap-5 mt-4 animate-fade-in bg-gray-50">
          ...
          <Button asChild size="lg" variant="outline" className="glass-blur-dark text-white border-white/30 hover:bg-white/10 backdrop-blur-sm px-8 py-6 rounded-lg text-base">
