...
export function ContactInfo() {
  return (
    <div className="space-y-8 animate-fade-up" style={{ animationDelay: "0.3s" }}>
      <div>
        <h2 className="text-2xl font-bold mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>Informações de Contato</h2>
        <p className="text-muted-foreground mb-8" style={{ fontFamily: "'Roboto', sans-serif" }}>
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-lg font-medium" style={{ fontFamily: "'Poppins', sans-serif" }}>Telefone</h3>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-lg font-medium" style={{ fontFamily: "'Poppins', sans-serif" }}>E-mail</h3>
              <p className="text-muted-foreground" style={{ fontFamily: "'Lato', sans-serif" }}>
      ...
      <div>
        <h2 className="text-2xl font-bold mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>Horário de Atendimento</h2>
      ...
      <div className="hidden md:block relative h-48 w-48 mx-auto animate-float">
        <img 
          src="/lovable-uploads/47db2abf-fda2-4030-848d-000f9ddac075.png" 
