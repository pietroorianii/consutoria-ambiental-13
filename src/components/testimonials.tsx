...
export function Testimonials() {
  return <section className="bg-muted py-16 md:py-24 relative">
      <div className="absolute inset-0 bg-opacity-5 leaf-pattern bg-lime-100"></div>
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => <Card key={index} className="bg-background border-none shadow-md hover:shadow-lg transition-all animate-fade-up" style={{
