      ...
      <div className="container flex h-16 items-center justify-between gap-4 overflow-hidden">
        <div className="flex min-w-0 items-center">
          <Link to="/" className="group flex min-w-0 items-center gap-3">
            ...
            />
            <span className="hidden whitespace-nowrap bg-gradient-to-r from-yellow-400 via-green-500 to-brand-primary bg-clip-text font-sora text-base font-extrabold leading-none text-transparent sm:block md:text-lg xl:text-xl">
