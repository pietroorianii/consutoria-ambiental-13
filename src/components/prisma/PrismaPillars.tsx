      ...
      <div className="container">
        <div className="grid md:grid-cols-3 gap-8">
          {pillars.map((pillar, index) => (
            <div 
              key={index}
              className="group bg-white rounded-lg border-t-4 border-prisma-green p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="w-16 h-16 bg-prisma-green/10 rounded-full flex items-center justify-center group-hover:bg-prisma-green/20 transition-colors">
