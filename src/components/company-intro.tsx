    ...
    <section className="container py-24 lg:py-32 relative">
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="space-y-8 scroll-trigger">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-gray-800 dark:text-gray-100" 
          ...
          <div className="pt-6 flex flex-wrap gap-5">
            ...
            <Button asChild variant="outline" 
                    className="border-eco-green text-eco-green hover:bg-eco-green/5 py-6 px-8 rounded-lg text-base">
