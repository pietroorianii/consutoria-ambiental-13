      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
        {services.map((service, index) => (
          ...
          >
            ...
            <CardContent className="flex justify-center mt-auto pt-4 pb-6 border-t border-gray-100 dark:border-gray-700/50">
              <Button 
                asChild 
                variant="link" 
                className="p-0 h-auto font-medium text-eco-green hover:text-eco-green-dark group hover-grow"
              >
