...
export const ServiceList = ({
  ...
  return <section className="container py-16 flex justify-center bg-lime-50">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl bg-lime-50 rounded-full">
