...
export const ServiceList = ({
  ...
  return <section className="container py-16 flex justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
        {services.map((service, index) => <Card key={index} className="eco-card border-eco-green/10 hover:border-eco-green/30 transition-all duration-300 bg-white/90 backdrop-blur-sm">
            <CardHeader>
            ...
            <CardContent className="flex justify-center">
              <Button asChild variant="link" className="p-0 h-auto font-medium text-eco-green hover:text-eco-green-dark">
