...
import { Leaf, Beaker, FileText, Users, TreeDeciduous, CloudSun, CheckCircle, ArrowRight } from "lucide-react";
const services = [{
  icon: <Leaf className="h-12 w-12 text-eco-green" />,
  title: "Licenciamento Ambiental",
  description: "Obtenção completa de licenças e autorizações ambientais",
  features: ["Licenças Prévias, de Instalação e Operação", "Autorizações para supressão de vegetação", "Cadastro Técnico Federal (IBAMA)", "Outorgas de recursos hídricos"],
  ...
  features: ["Acompanhamento de condicionantes", "Declaração de Carga Poluidora", "Monitoramento de emissões", "Gestão de amostragens e análises"],
  ...
  features: ["Inventário de Resíduos Sólidos", "Planos de Gerenciamento (PGRS, PGRSS)", "Estudos de Impacto Ambiental", "Programas de Gestão Ambiental"],
  ...
  features: ["Acompanhamento de projetos", "Relatórios para Auto de Infração", "Inspeções e auditorias ambientais", "Relatórios de cumprimento"],
  ...
  features: ["Treinamentos presenciais e remotos", "Gerenciamento de Resíduos Sólidos", "Capacitações específicas por setor", "Certificação de participantes"],
  ...
  features: ["Renovação de licenças e autorizações", "Declarações e inventários anuais", "Defesas administrativas", "Manutenções periódicas"],
      ...
      <div className="container relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          <div className="lg:w-2/3">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-gray-900" style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
          {services.map((service, index) => <Card key={index} className={`group hover:shadow-xl transition-all duration-500 bg-gradient-to-br ${service.bgColor} backdrop-blur-sm border-2 ${service.borderColor} hover:border-opacity-40 h-full`}>
              <CardHeader className="pb-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-grow">
                    <CardTitle className="text-xl mb-2 group-hover:text-eco-green-dark transition-colors" style={{
                  fontFamily: "'Poppins', sans-serif"
                }}>
                      {service.title}
                    </CardTitle>
                    <CardDescription className="text-gray-600 text-base" style={{
                  fontFamily: "'Montserrat', sans-serif"
                }}>
                      {service.description}
                    </CardDescription>
              ...
              <CardContent className="pt-0">
                ...
                <Button asChild className="w-full bg-eco-green hover:bg-eco-green-dark text-white group-hover:scale-105 transition-all duration-300">
